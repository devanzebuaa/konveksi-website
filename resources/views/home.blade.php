...
<section class="hero-section bg-primary text-white py-5">
    <div class="container-fluid">
        <div class="row align-items-center gx-0">
            <div class="col-lg-6 ps-lg-5 pe-lg-0 mb-4 mb-lg-0">
                ...
                <a href="{{ route('products.index') }}" class="btn btn-light btn-lg me-2">Lihat Produk</a>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="carousel-inner">
                        @for ($i = 1; $i <= 5; $i++)
                            <div class="carousel-item {{ $i === 1 ? 'active' : '' }}">
                                <img src="{{ asset("images/beranda/polo$i.jpg") }}" class="d-block mx-auto img-fluid" style="height: 400px; object-fit: contain;" alt="Polo {{ $i }}">
                            </div>
                        @endfor
                    </div>
                </div>
